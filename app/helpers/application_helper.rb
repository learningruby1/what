...
#       if get_physical_custody == 'Yes' && get_number_of_child(_document) != '1'
...
#     unless get_number_of_child(_document).nil?
#       count = get_number_of_child(_document).to_i
#       sole_count = get_number_of_primary_or_sole_child(_document).to_i
#       joint_count = get_number_of_joint_child(_document).to_i
#       if text.match(/<child_count>/) || text.match(/<child_count_spain>/) || text.match(/<residency_child>/) || text.match(/<residency_child_second>/) || text.match(/<child_joint_count>/) || text.match(/<child_joint_count_spain>/)
#         if count == 1
