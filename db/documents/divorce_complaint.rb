...
toggle_id = 0
toggle_id += 1
current_step.fields.create :field_type => 'text review_show', :name => '<insert> addresses <spain/><insert> direcciones', :header_ids => "#{ child_name.id }/#{ child_last_name.id }", :sort_index => 'a1'
