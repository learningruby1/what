...
current_step.fields.create :field_type => 'date_birthday_start_range=-13_end_range=-100', :name => 'Date of Birth /<spain/>Fecha de nacimiento: *', :mandatory => { :value => /^[0-9]{1,2}\/[0-9]{1,2}\/[0-9]{4}$/, :hint => 'Please enter a date of birthday /<spain/>Por favor, ponga la fecha de nacimiento' }
...
current_step.fields.create :field_type => 'date_year_born_end_range=1 review_show', :name => 'When is unborn child due? /<spain/>¿Qué fecha va nacer él bebe?', :toggle_id => toggle_id, :toggle_option => 'IS currently pregnant', :mandatory => { :value => /^[0-9]{1,2}\/[0-9]{1,2}\/[0-9]{4}$/, :hint => 'Please enter a date/<spain/>Por favor, introduzca una fecha' }
...
child_birth = current_step.fields.create :field_type => 'date_for_child_end_range=-19', :name => 'Date of Birth /<spain/>Fecha de nacimiento: *', :mandatory => { :value => /^[0-9]{1,2}\/[0-9]{1,2}\/[0-9]{4}$/, :hint => 'Please enter a date of birthday /<spain/>Por favor, ponga la fecha de nacimiento' }
...
current_step.fields.create :field_type => 'date_without_day_start_range=-5 review_show', :name => 'I want back <child_count> support starting /<spain/>Quiero la manutención de <child_count_spain> a partir', :toggle_id => toggle_id, :toggle_option => 'Yes', :mandatory => { :value => /^[0-9]{1,2}\/[0-9]{1,2}\/[0-9]{4}$/, :hint => 'Please select date /<spain/>Por favor seleccione la fecha' }
...
current_step.fields.create :field_type => 'date_without_day_end_range=-100 rev_inline',
...
current_step.fields.create :field_type => 'date_year_only_end_range=-100',
